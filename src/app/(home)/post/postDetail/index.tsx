      ...
      <div className="w-[40%] pr-[16px] bg-transparent flex-shrink-0 flex flex-col justify-between items-start">
        <div className="flex flex-col gap-y-4">
          <div className="flex items-center justify-start gap-x-3">
            ...
            <div className="flex flex-col items-start justify-start gap-y-1">
              <div className="bg-[#3DBDA7] px-1 py-[2px] min-w-[188px] rounded-[72px] flex items-center justify-start gap-x-2">
                ...
                <div className="text-[#393939] text-sm font-semibold">
                  League of Legends
                </div>
              </div>
          ...
          <div className="text-[#F4F5F6] font-medium text-sm">
            Say what ever the fuck you want in here to describe your horrible
            game
          </div>
        </div>
        <div className="flex items-center justify-start gap-x-3">
          ...
          <div className="flex justify-start items-center">
            <div className="h-10 bg-white rounded-[44px] px-3 py-2 flex items-center gap-x-2 translate-x-[-40px]">
              ...
              <div className="text-[#00453F] font-medium text-sm">
                +980000 Reviews
              </div>
            </div>
          </div>
