...
const ViewApplyInformationModal = () => {
  ...
  return (
    <Modal
      isOpen={isOpen}
      onChange={onChange}
      className="max-w-[900px] max-h-[900px] overflow-y-scroll bg-background pt-10 pb-12 px-9 !rounded-2xl remove-button"
    >
      ...
      <div className="flex gap-y-6 flex-wrap">
        ...
        <div className="flex items-center w-1/2">
          ...
          {<div className="line-clamp-1 max-w-[70%]">{data.is_accepted} </div>}
        </div>
      ...
      <div className="font-bold my-4 text-2xl text-teal-500">Social Links</div>
      <div className="flex gap-y-6 flex-wrap">
        <div className="flex items-center w-1/2">
      ...
      {data.support_images && data.support_images.length > 0 && (
        <>
          ...
          <div ref={imageSlider[0]} className="keen-slider mt-0 pt-0">
